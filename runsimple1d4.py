...
if ans == '':
    ...
    Nice0 = pickle.load(f)
    x = pickle.load(f)
    diffperdt= pickle.load(f)                 #before it said = pickle.load(f)
...
#I added this stuff to hopefully code for different pertibation    
    xmax = 501
    supersat = 0.04                #not sure if the following was used in this model
    supersatpfactor = 0.9
    alpha_terr = 0.5
    alpha_edge = 1.0
